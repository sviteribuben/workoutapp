...
![Экран ввода данных](src_workout/img/z.jpg)

![Экран статистики](src_workout/img/v.jpg)
...
- **[ty](https://github.com/astral-sh/ty)** - статический анализатор типов для проверки кода
...
Код проекта проверяется с помощью [ty](https://github.com/astral-sh/ty) - высокопроизводительного статического анализатора типов от Astral.
