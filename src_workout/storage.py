...
def load_data() -> dict:
    # If the data file doesn't exist or is empty, start with an empty structure
    ...
    with DATA_FILE.open("r", encoding="utf-8") as f:
        try:
            ...
            # If the file content is invalid JSON, reset to an empty structure
            return {"workouts": []}


def add_workout(was_done: bool, w_type: str, comment: str) -> None:
    data = load_data()
